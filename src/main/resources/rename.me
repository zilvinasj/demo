...
INSERT into USERS_FAVOURITES (USERS_ID, FAVOURITES_AMG_ARTIST_ID) values (1, 3252083);
INSERT into USERS_FAVOURITES (USERS_ID, FAVOURITES_AMG_ARTIST_ID) values (1, 2305861);
